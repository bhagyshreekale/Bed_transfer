      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              const Text("Personal Deatils", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
            ],
          ),
          ...
          //Select Gender Male
            ...
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              const Text("Select Gender", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
            ],
          ),
           Radiobuttons(
            title: "Male",
          ...
          TextfieldCustom(
            controller: a ,
            labelTextInput: "Reason for Addmission/Diagnosis", 
          ...
          //Bed Transfer Details
           Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              const Text("Bed Transfer Deatils", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
            ],
          ),
          SizedBox(height: 20,),
          ...
          CustomDropdownTextField(
            ...
            value: selectedDoctor,
            items: ["General Ward", "Semi-Private Ward", "Private Ward", "ICU (Intensive Care Unit)"],
            onChanged: (val) {
             setState(() {
             selectedDoctor = val;
            });
